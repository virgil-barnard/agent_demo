            ...
            "candidates": [
                {
                    ...
                    "score": {
                        "tier": 1,
                        "kind": "issue",
                        "path": "docs/issues/CA-001-graph.md",
                        "anchor": 1,
                    },
                    "rationale": "selected issue",
                    "evidence_route": ["issue:CA-001"],
                },
                {
                    ...
                    "rationale": "declared requirement",
                ...
                },
                {
                    ...
                    "mandatory": False,
                    "rank": 3,
                    "score": {"tier": 3, "kind": "source", "path": "src/demo.py", "anchor": 1},
                    "rationale": "declared implementation",
                ...
                },
                {
                    ...
                    "mandatory": False,
                    "rank": 4,
                    "score": {"tier": 3, "kind": "test", "path": "tests/test_demo.py", "anchor": 1},
                    "rationale": "declared test",
                    "evidence_route": ["issue:CA-001", "test:tests/test_demo.py"],
                },
                {
                    "artifact_id": "artifact:document:docs/requirements.md",
                    "mandatory": False,
                    "rank": 5,
                    "score": {
                        "tier": 5,
                    ...
                    "rationale": "supporting document reached by requirement provenance",
                    "evidence_route": [
                        "issue:CA-001",
                        "requirement:REQ-CA-001",
